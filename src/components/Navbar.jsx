      ...
      <div class="header">
          <div class="utility-navigation" className='w-full hidden lg:md:flex px-[6em] py-[.5em] bg-[#F5F6F6]'>
              <div class="utility-nav-left" className='w-1/3 px-4'>
                    <a href="tel:866.952.7200" className='font-[400] lg:md:text-sm sm:text-xs'>
              ...
              <div class="utility-nav-right" className='w-2/3 text-right lg:md:pr-10 sm:pr-2'>
                  <a href="/" className="px-3 inline-block font-[400] lg:md:text-sm sm:text-xs"> Utility Navigation Link One </a>
                  <a href="/" className="px-3 inline-block font-[400] lg:md:text-sm sm:text-xs"> Utility Navigation Link Two </a>
              </div>
          </div>

          <div className="w-full lg:flex hidden xl:px-16 px-5 py-4">
                <div class="topspot-logo" className="w-1/5 inline-block min-w-[15em]">
                  <img class="logo" src={TopSpotLogo} alt="topspot logo" className="h-10 p-auto m-auto"></img>
                 </div>
                 <div class="navigation-boxes" className="w-4/5 py-2 lg:pr-14 pr-0">
                    <div className='float-right'>
                        <li className="text-[0.85em] font-[600] inline-block px-5 "> <a className="text-[#E56E39]" href="/"> HOME </a> </li>
                        <li className="text-[0.85em] font-[600] inline-block px-5"> <a href="/">  ABOUT </a> </li>
                        <li className="text-[0.85em] font-[600] inline-block px-5"> <a href="/">  SERVICES  </a> </li>
                        <li className="text-[0.85em] font-[600] inline-block px-5"> <a href="/">  CONTACT  </a> </li>
          ...
          <div className={!nav ? 'hidden' : 'block lg:hidden py-4'}>
              <div class="navigation-boxes" className="text-center m-auto flex">
                  <div className="m-auto">
                      <li className="font-[600] text-sm inline-block px-4"> <a href="/" className="text-[#E56E39]"> HOME </a> </li>
                      <li className="font-[600] text-sm inline-block px-4"> <a href="/"> ABOUT </a> </li>
                      <li className="font-[600] text-sm inline-block px-4"> <a href="/"> SERVICES </a> </li>
                      <li className="font-[600] text-sm inline-block px-4"> <a href="/"> CONTACT </a> </li>
                  </div>
                </div>
          </div>
